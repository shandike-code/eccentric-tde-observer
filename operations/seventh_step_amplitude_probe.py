"""Bounded step-seven amplitude test from the audited sixth confirmation.

Only numerical relaxation changes: 1/128, then 1/256 if not accepted.
...
SOURCE = 'outputs/hpc/outer-steps456-20260921/step6/next-step'
