"""Two-map control of the smallest existing candidate from archived base radiation.
...
SOURCE='outputs/hpc/small-step-a00390625-cont24-20260918'
ALPHA=0.00390625
MAXIMUM_MAPS=2
WORKERS=2
...
def main():
    ...
    try:
        ...
        declaration={'scope':'common-seed candidate check; never material acceptance','maximum_new_maps':2,'workers':2,
                     ...
                     'pre_run_check':{'code':'exact existing candidate identity and native input checks',
                                      'logic':'archived I and smallest existing candidate, two maps and feedbacks, compare with archived base and prior candidate',
