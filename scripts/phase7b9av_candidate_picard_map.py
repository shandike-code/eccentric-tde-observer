"""Phase 7B9av：执行约束 Anderson 候选的正 Picard 映射。"""
...
EXPECTED_PROTOCOL_SHA256 = "133f2830816ab3d5ef0054baa97760d98b43702355bf0e9fb6b383923ef20d8b"
...
def main() -> None:
    ...
    parser.add_argument(
        "--protocol",
        type=Path,
        default=ROOT / "outputs/phase7b9av_preregistered_candidate_picard_map.json",
    )
