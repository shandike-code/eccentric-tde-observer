"""Phase 7B9by：执行慢模 Anderson 候选的完整原算子映射。"""
...
EXPECTED_PROTOCOL_SHA256 = "b4e2a62e95a1faaac4bf211e857085a695f21c041e779011619b2640b31cff15"
...
def main() -> None:
    ...
    parser.add_argument(
        "--protocol",
        type=Path,
        default=ROOT / "outputs/phase7b9by_preregistered_slow_mode_candidate_map.json",
    )
