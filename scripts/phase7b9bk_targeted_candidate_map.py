...
EXPECTED_PROTOCOL_SHA256 = "6e88d4cf894afc27f1e3018eab0d45de3370778a57ff2242504340bbaa30e806"
...
def main() -> None:
    ...
    parser.add_argument(
        "--protocol",
        type=Path,
        default=ROOT / "outputs/phase7b9bk_preregistered_targeted_candidate_map.json",
    )
