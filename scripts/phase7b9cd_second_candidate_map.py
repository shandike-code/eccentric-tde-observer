...
EXPECTED_PROTOCOL_SHA256 = "6e5db9d621b58a93b2197e0b5ceac40072157896cc14187db503d02701fe22de"
...
def main() -> None:
    ...
    parser.add_argument(
        "--protocol",
        type=Path,
        default=ROOT / "outputs/phase7b9cd_preregistered_second_candidate_map.json",
    )
