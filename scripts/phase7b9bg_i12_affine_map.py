"""Phase 7B9bg：执行 I12 连续态的仿射 Krylov 映射。"""
...
EXPECTED_PROTOCOL_SHA256 = "d6e9a59e44ace3c1f5b9a35ed3475235631f5f4990f6330077510f76e6929b44"
...
def main() -> None:
    ...
    parser.add_argument(
        "--protocol",
        type=Path,
        default=ROOT / "outputs/phase7b9bg_preregistered_i12_affine_map.json",
    )
