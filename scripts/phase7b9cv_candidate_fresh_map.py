"""Phase 7B9cv：执行哈希锁定的候选 fresh map。"""
...
EXPECTED_PROTOCOL_SHA256 = "c342305b767ec7f433b84ac0fa8f356399ff647a87d042aff055144422e3ab35"
...
def main() -> None:
    ...
    parser.add_argument(
        "--protocol",
        type=Path,
        default=ROOT / "outputs/phase7b9cv_preregistered_candidate_fresh_map.json",
    )
