...
## 22:32第一轮确认通过，第二轮尚未反馈

76727仍RUNNING、32CPU/anode05、stderr空、watcher存活。22:32:58快照：confirm1两张map完整，残差1.168081447354e-5、1.117346910744e-5。confirm2已完成第1张（1.068650209774e-5），第2张active、0个已提交块，尚无该轮完整反馈；不是全批完成。

confirm1原16门全部通过，heat1.422588315819e-4、noise0.04085336626109，原r19分母三比0.980668103186/0.975023285231/0.998213269818。相对新control四组合全收缩，最不利L2/质量加权/最大单元比0.980008090493/0.973845830282/0.998128823520。

两端点最低gas6.127643424465145e12/6.165136444747105e12 erg/g，0失败单元、各12项完整态检查通过；152反馈回执exit0/memory门通过，峰/proc4039036KiB、原生3944.37109375MiB、两态批墙钟308.974297/311.062628秒。prev范数8.168167774958/0.261726592083/2.704708909437，final8.169170646219/0.261771838045/2.704811959502，仍有小幅漂移，不能把通过门称为全状态收敛。

按既定预算继续第二轮，学校pair summary的有限步标记不是本项目独立接受记录；总计数仍19/new0。终态仍需Mac独立审阅，不重交或增预算。证据`20260924-confirmation20-76727-first-pair-progress.json`；备份`pre-confirmation20-first-pair-progress.bundle`与`automation-before-confirmation20-first-pair-progress.toml`。仅新增记录，未修改已声明代码或数值工件。
